...
class KNN:
    ...
    def get_k_neighbours(self, unclassified_point):
        ...
        k_neighbours_distances_and_tags =  distances.argsort()[self.__k_constant:] #https://stackoverflow.com/questions/16817948/i-have-need-the-n-minimum-index-values-in-a-numpy-array
    ...
    def get_k_neighbours_tags(self, k_neighbours):
        k_neighbours_tags = [i[1] for i in k_neighbours] # https://stackoverflow.com/questions/17710672/create-2-dimensional-array-with-2-one-dimensional-array
